  ...
  <div style="padding: 10px 12px;" v-if="current">
    <a-form :label-col="labelCol" :wrapper-col="wrapperCol">
      ...
      <a-form-item label="评分间距">
        <a-input-number
          style="width: 100%"
          v-model:value="current.attrs.spacing"
          :min="0"
          placeholder="请输入按钮文案"
        ></a-input-number>
      </a-form-item>
      ...
      <a-form-item label="选中图标">
        <a-input v-model:value="current.attrs.checkedIcon" placeholder="请输入按钮图标" allowClear></a-input>
        <a-button
          style="margin-top: 20px;"
          type="primary"
          @click="clickBtn('checkedIcon')"
          size="small"
        >选择图标</a-button>
      </a-form-item>
      <a-form-item label="未选中图标">
        <a-input v-model:value="current.attrs.uncheckedIcon" placeholder="请输入按钮图标" allowClear></a-input>
        <a-button
          style="margin-top: 20px;"
          type="primary"
          @click="clickBtn('uncheckedIcon')"
          size="small"
        >选择图标</a-button>
      </a-form-item>
